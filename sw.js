...
const CORE = [
  ...
  'js/route.js', 'js/geo.js', 'js/extras.js', 'js/lista.js', 'js/crm.js', 'js/descuentos.js', 'js/app.js',
  'js/views/login.js', 'js/views/admin.js', 'js/views/rutas.js', 'js/views/repartidor.js', 'js/views/club.js', 'js/views/clientes.js', 'js/views/metricas.js', 'js/views/produccion.js', 'js/views/descuentos.js', 'js/views/promos.js', 'js/views/vendedores.js',
