...
const CORE = [
  ...
  'js/views/login.js', 'js/views/admin.js', 'js/views/rutas.js', 'js/views/repartidor.js', 'js/views/club.js', 'js/views/clientes.js', 'js/views/metricas.js', 'js/views/produccion.js', 'js/views/descuentos.js', 'js/views/promos.js',
